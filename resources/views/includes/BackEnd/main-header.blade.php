        ...
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}"><img src="{{ URL::asset('BackEnd/images/logo-dark.png') }}" alt="Logo"></a>
                <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}"><img src="{{ URL::asset('BackEnd/images/logo-icon-dark.png') }}" alt=""></a>
            </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <div class="btn-group mb-1">
                    <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img src="{{ URL::asset('BackEnd/images/flags/EG.png') }}" alt="">
                        @else
                        {{ LaravelLocalization::getCurrentLocaleName() }}
                        <img src="{{ URL::asset('BackEnd/images/flags/US.png') }}" alt="">
                        @endif
                    </button>
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        {{-- <img src="{{ URL::asset('BackEnd/images/user_icon.png') }}" alt="avatar"> --}}
                        <img src="{{ asset('images/users/' . Auth::user()->avatar) }}" alt="avatar">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-header">
                            <div class="media">
                                <div class="media-body">
                                    <h5 class="mt-0 mb-0">{{ Auth::user()->username }}</h5>
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}"
                            ...
                            document.getElementById('logout-form').submit();"><i class="text-danger ti-unlock"></i>{{ __('Logout') }}
                        </a>
